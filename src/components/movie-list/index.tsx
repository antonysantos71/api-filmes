...
export function MovieList() {
  ...
  return (
    ...
    <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      {movies.map((movie) => (
        <li key={movie.id} className="bg-zinc-800 shadow-lg rounded-lg overflow-hidden">
          <img
          ...
          <div className="p-4">
            ...
            <p className="text-gray-500 text-sm line-clamp-3 mb-4">{movie.overview}</p>
            <div className="flex items-center justify-between">
              <span className="text-yellow-500 font-semibold text-xl">{movie.vote_average}</span>
